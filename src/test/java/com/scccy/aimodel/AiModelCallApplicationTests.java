...
class AiModelCallApplicationTests {
    ...
    void c() {
        ...
        List<MappingItem> generatedParamItem = reverseBuilder.getParamItems();
        ...
        List<MappingItem> generatedHeaderItem = headerBuilder.getHeaderItems();
        ...
        generatedParamItem.forEach(item -> System.out.println(JSONObject.toJSONString(item)));
        System.out.println("\n========== 反向解析生成的 headerItem 配置 ==========");
        generatedHeaderItem.forEach(item -> System.out.println(JSONObject.toJSONString(item)));
    }
